...
code = code.replace(/const handleSpeak = async \(id: string, text: string\) => \{[\s\S]*?showErrorBox\("Browser Anda tidak mendukung fitur suara \(Text-to-Speech\)\."\);\n    \}\n  \};/, ttsFunc);

fs.writeFileSync('src/components/ChatArea.tsx', code);
console.log("Updated ChatArea.tsx TTS 2");
