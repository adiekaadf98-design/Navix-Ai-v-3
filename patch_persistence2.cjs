...
for (const file of files) {
  ...
  if (file === 'AudioStudio.tsx') patchState('audioLibrary', 'navix_audio_library');
  if (file === 'ImageStudio.tsx') patchState('generatedImages', 'navix_image_gallery');
  if (file === 'MediaLibrary.tsx') patchState('mediaList', 'navix_media_vault');
